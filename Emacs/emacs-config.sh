...
(custom-set-variables
 ...
 '(lsp-java-9-args
   '("--add-modules=ALL-SYSTEM" "--add-opens java.base/java.util=ALL-UNNAMED" "--add-opens java.base/java.lang=ALL-UNNAMED" "--enable-preview"))
 ...
 '(package-selected-packages
   '(use-package helm-lsp dracula-theme posframe lsp-ui lsp-mode groovy-mode forge magit memoize lsp-javacomp lsp-java jtags javadoc-lookup java-imports gradle-mode flycheck-popup-tip flycheck-gradle company-rtags company-c-headers clang-format))
...
(use-package company)
(use-package company-rtags :defer 1)
(global-company-mode)
